 ...
 * @return array
 */
function jazzbanktransfer_MetaData()
{
    return array(
        'DisplayName' => 'JazzCash DD Payment Gateway Module',
 ...
 * @return array
 */
function jazzbanktransfer_config()
{
    return array(
 ...
 * @return string
 */
function jazzbanktransfer_link($params)
{
 ...
 */
function jazzbanktransfer_refund($params)
{
   return true;
}
 ...
 * @return array Transaction response status
 */
function jazzbanktransfer_cancelSubscription($params)
{
    return true;
}
